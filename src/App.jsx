...
const QUESTIONS = [
  { id: 1, question: "En sevdiğim içecek hangisi?", options: ["Kahve", "Çay", "Kola", "Limonata"], correct: "Kahve" },
  { id: 2, question: "Boş zamanımda en çok ne yaparım?", options: ["Kitap okurum", "Oyun oynarım", "Spor yaparım", "Uyurum"], correct: "Oyun oynarım" },
  { id: 3, question: "En sevdiğim mevsim hangisi?", options: ["Yaz", "Kış", "İlkbahar", "Sonbahar"], correct: "Sonbahar" },
  { id: 4, question: "En sevdiğim renk hangisi?", options: ["Siyah", "Mavi", "Kırmızı", "Yeşil"], correct: "Siyah" },
  { id: 5, question: "Bir yere geç kalırsam sebebi genelde nedir?", options: ["Trafik", "Hazırlanamamak", "Telefonla oyalanmak", "Uyuyakalmak"], correct: "Telefonla oyalanmak" },
  { id: 6, question: "En sevdiğim müzik türü hangisi?", options: ["Pop", "Rock", "Rap", "Lo-fi"], correct: "Rock" },
  { id: 7, question: "Tatilde en çok neyi tercih ederim?", options: ["Deniz", "Dağ evi", "Şehir gezisi", "Kamp"], correct: "Dağ evi" },
  { id: 8, question: "En sevdiğim yemek türü hangisi?", options: ["Hamburger", "Pizza", "Makarna", "Döner"], correct: "Pizza" },
  ...
  { id: 13, question: "En sevdiğim hava nasıl olur?", options: ["Güneşli", "Yağmurlu", "Sisli", "Karlı"], correct: "Yağmurlu" },
  { id: 14, question: "Bir oyunda en çok hangi rolü seçerim?", options: ["Tank", "Destek", "Saldırı", "Keskin nişancı"], correct: "Destek" },
  { id: 15, question: "En çok hangi tatlıyı severim?", options: ["Cheesecake", "Tiramisu", "Baklava", "Sufle"], correct: "Cheesecake" },
  ...
  { id: 17, question: "Telefonumun şarjı düşünce ne yaparım?", options: ["Hemen şarja takarım", "Powerbank ararım", "Umursamam", "Uçak moduna alırım"], correct: "Hemen şarja takarım" },
  { id: 18, question: "En sevdiğim oyun türü hangisi?", options: ["FPS", "RPG", "Strateji", "Korku"], correct: "RPG" },
  { id: 19, question: "En çok hangi hayvanı severim?", options: ["Kedi", "Köpek", "Kuş", "Balık"], correct: "Kedi" },
  { id: 20, question: "Beni en iyi anlatan özellik hangisi?", options: ["Sabırlı", "İnatçı", "Komik", "Sessiz"], correct: "İnatçı" },
];
